#!/usr/bin/env python3
"""Aggregate exp8 (CodeBERT-Mixed) 5-seed results into mean ± std JSON."""
...
per_seed = {}
for s in SEEDS:
    p = DEVIGN / f"codebert_mixed_seed{s}_results.json"
    if p.exists():
...
out = DEVIGN / "codebert_mixed_multiseed_results.json"
