#!/usr/bin/env python3
"""ReGVD 5-seed multiseed evaluation on DiverseVul balanced subset."""
...
def main():
    ...
    print(f"Graphs built for conditions: {list(test_datasets.keys())}", flush=True)
    ...
    agg = {"n_seeds": len(SEEDS), "seeds": SEEDS, "model": "ReGVD", "dataset": "DiverseVul"}
    for cond in conds:
    ...
    out = RESULTS_DIR / "diversevul_regvd_multiseed_results.json"
