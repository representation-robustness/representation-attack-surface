#!/usr/bin/env python3
"""CPG + Logistic Regression on Big-Vul — all 7 obfuscation conditions."""
...
def main():
    ...
    out.update({"model": "CPG+LR", "dataset": "Big-Vul",
    ...
    result_path = RESULTS_DIR / "cpglr_7cond_bigvul_results.json"
