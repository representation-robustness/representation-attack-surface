#!/usr/bin/env python3
"""CodeBERT 5-seed multiseed evaluation on ReVeal dataset."""
...
CKPT_DIR    = SCRIPT_DIR / "ckpts_reveal_codebert"
...
def train_one_seed(seed, tokenizer, train_recs, valid_recs, test_sets):
    set_seed(seed)
    print(f"\n{'='*55}\n  CodeBERT ReVeal  Seed {seed}\n{'='*55}", flush=True)
    ckpt = CKPT_DIR / f"codebert_reveal_seed{seed}.pt"
...
def main():
    ...
    agg = {"n_seeds": len(SEEDS), "seeds": SEEDS, "model": "CodeBERT", "dataset": "ReVeal"}
    for cond in conds:
    ...
    out = RESULTS_DIR / "reveal_codebert_multiseed_results.json"
