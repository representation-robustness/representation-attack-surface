...
class DevignModel(nn.Module):
    ...
    def forward(self, batch, cuda=False, device=None):
        ...
        # Return raw logits — BCEWithLogitsLoss in main.py applies sigmoid internally.
        # Evaluation pipeline (_extract_scores in trainer.py) applies sigmoid separately.
        return avg.squeeze(dim=-1)
